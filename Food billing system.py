...
lblTitle=Label(Tops,font=('arial',60,'bold'),text='Food Billing System',bd=21,bg='sky blue',
...
Cal_F=Frame(ReceiptCal_F,bg='sky blue',bd=6,relief=RIDGE)
Cal_F.pack(side=TOP)

Receipt_F=Frame(ReceiptCal_F,bg='sky blue',bd=4,relief=RIDGE)
Receipt_F.pack(side=BOTTOM)

MenuFrame = Frame(root,bg='sky blue',bd=10,relief=RIDGE)
MenuFrame.pack(side=TOP)
Cost_F=Frame(MenuFrame,bg='sky blue',bd=4)
Cost_F.pack(side=BOTTOM)
Drinks_F=Frame(MenuFrame,bg='sky blue',bd=4)
Drinks_F.pack(side=TOP)


Drinks_F=Frame(MenuFrame,bg='sky blue',bd=4,relief=RIDGE)
Drinks_F.pack(side=LEFT)
Food_F=Frame(MenuFrame,bg='sky blue',bd=4,relief=RIDGE)
...
def CostofItem():
    ...
    Sprite=float(E_Sprite.get())
    Pepsi=float(E_Pepsi.get())
    DietCoke=float(E_DietCoke.get())
    Mojito=float(E_Mojito.get())
    Cappuccino=float(E_Cappuccino.get())
    Fanta=float(E_Fanta.get())
    CocaCola=float(E_CocaCola.get())
    ColdCoffee=float(E_ColdCoffee.get())
    BlackCoffee=float(E_BlackCoffee.get())

    HotDog=float(E_HotDog.get())
    VegBurger=float(E_VegBurger.get())
    Pasta=float(E_Pasta.get())
    HamBurger=float(E_HamBurger.get())
    Sandwich=float(E_Sandwich.get())
    Fires=float(E_Fires.get())
    Spagetti=float(E_Spagetti.get())
    Fazitas=float(E_Fazitas.get())
    Roll=float(E_Roll.get())

    PriceofDrinks =(Sprite * 30) + (Pepsi * 30) + (DietCoke * 40) + ( Mojito * 130) + (Cappuccino * 180) + ( Fanta * 30) + (CocaCola * 30 ) + (ColdCoffee * 200) + (BlackCoffee * 100)

    PriceofFood =( HotDog * 260) + (VegBurger * 175) + (Pasta * 255) + (HamBurger * 480) + (Spagetti * 240) + (Sandwich * 110) + (Fires * 340) + ( Fazitas * 213) + (Roll * 50)
...
txtBlackCoffee.grid(row=8,column=1)

#############################################Foods######################################################################

HotDog = Checkbutton(Food_F,text="HotDog\t\t\t ",variable=var9,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_HotDog).grid(row=0,sticky=W)
VegBurger = Checkbutton(Food_F,text="VegBurger",variable=var10,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_VegBurger).grid(row=1,sticky=W)
Pasta = Checkbutton(Food_F,text="Pasta ",variable=var11,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_Pasta).grid(row=2,sticky=W)
HamBurger = Checkbutton(Food_F,text="Rice Plate ",variable=var12,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_HamBurger).grid(row=3,sticky=W)
Sandwich = Checkbutton(Food_F,text="Sandwich ",variable=var13,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_Sandwich).grid(row=4,sticky=W)
Fires = Checkbutton(Food_F,text="Fires ",variable=var14,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_Fires).grid(row=5,sticky=W)
Spagetti = Checkbutton(Food_F,text="Spagetti ",variable=var15,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_Spagetti).grid(row=6,sticky=W)
Fazitas = Checkbutton(Food_F,text="Fazitas ",variable=var16,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_Fazitas).grid(row=7,sticky=W)
Roll = Checkbutton(Food_F,text="Roll ",variable=var18,onvalue = 1, offvalue=0,
                        font=('arial',18,'bold'),bg='sky blue',command=chk_Roll).grid(row=8,sticky=W)
################################################Entry Box For Cake##########################################################
...
txtRoll=Entry(Food_F,font=('arial',16,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED,
                        textvariable=E_Roll)
txtRoll.grid(row=8,column=1)
###########################################ToTal Cost################################################################################
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Drinks\t',bg='sky blue',
                fg='black',justify=CENTER)
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Foods  ',bg='sky blue',
                fg='black',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Service Charge',bg='sky blue',
                fg='black',justify=CENTER)
...
lblPaidTax=Label(Cost_F,font=('arial',14,'bold'),text='\tPaid Tax',bg='sky blue',bd=7,
                fg='black',justify=CENTER)
...
lblSubTotal=Label(Cost_F,font=('arial',14,'bold'),text='\tSub Total',bg='sky blue',bd=7,
                fg='black',justify=CENTER)
...
lblTotalCost=Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='sky blue',bd=7,
                fg='black',justify=CENTER)
...
###########################################BUTTONS################################################################################
btnTotal=Button(Buttons_F,padx=16,pady=1,bd=7,fg='blue',font=('arial',16,'bold'),width=4,text='Total',
                        bg='salmon',command=CostofItem).grid(row=0,column=0)
btnReceipt=Button(Buttons_F,padx=16,pady=1,bd=7,fg='blue',font=('arial',16,'bold'),width=4,text='Receipt',
                        bg='salmon',command=Receipt).grid(row=0,column=1)
btnReset=Button(Buttons_F,padx=16,pady=1,bd=7,fg='blue',font=('arial',16,'bold'),width=4,text='Reset',
                        bg='salmon',command=Reset).grid(row=0,column=2)
btnExit=Button(Buttons_F,padx=16,pady=1,bd=7,fg='blue',font=('arial',16,'bold'),width=4,text='Exit',
                        bg='salmon',command=iExit).grid(row=0,column=3)
#btnTotall=Button(Buttons_F,padx=16,pady=1,bd=7,fg='blue',font=('arial',16,'bold'),width=4,text='Total',
                     #   bg='salmon',command=CostofItem).grid(row=1,column=0)
...
btn7=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='7',
                        bg='dodgerblue',command=lambda:btnClick(7)).grid(row=2,column=0)
btn8=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='8',
                        bg='dodgerblue',command=lambda:btnClick(8)).grid(row=2,column=1)
btn9=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='9',
                        bg='dodgerblue',command=lambda:btnClick(9)).grid(row=2,column=2)
btnAdd=Button(Cal_F,padx=16,pady=1,bd=7,fg='red',font=('arial',16,'bold'),width=4,text='+',
                        bg='dodgerblue',command=lambda:btnClick('+')).grid(row=2,column=3)
###########################################CALCULATOR BUTTONS################################################################################
btn4=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='4',
                        bg='dodgerblue',command=lambda:btnClick(4)).grid(row=3,column=0)
btn5=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='5',
                        bg='dodgerblue',command=lambda:btnClick(5)).grid(row=3,column=1)
btn6=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='6',
                        bg='dodgerblue',command=lambda:btnClick(6)).grid(row=3,column=2)
btnSub=Button(Cal_F,padx=16,pady=1,bd=7,fg='red',font=('arial',16,'bold'),width=4,text='-',
                        bg='dodgerblue',command=lambda:btnClick('-')).grid(row=3,column=3)
###########################################CALCULATOR BUTTONS################################################################################
btn1=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='1',
                        bg='dodgerblue',command=lambda:btnClick(1)).grid(row=4,column=0)
btn2=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='2',
                        bg='dodgerblue',command=lambda:btnClick(2)).grid(row=4,column=1)
btn3=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='3',
                        bg='dodgerblue',command=lambda:btnClick(3)).grid(row=4,column=2)
btnMulti=Button(Cal_F,padx=16,pady=1,bd=7,fg='red',font=('arial',16,'bold'),width=4,text='*',
                        bg='dodgerblue',command=lambda:btnClick('*')).grid(row=4,column=3)
###########################################CALCULATOR BUTTONS################################################################################
btn0=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='0',
                        bg='dodgerblue',command=lambda:btnClick(0)).grid(row=5,column=0)
btnClear=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='C',
                        bg='dodgerblue',command=btnClear).grid(row=5,column=1)
btnEqual=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='=',
                        bg='dodgerblue',command=btnEquals).grid(row=5,column=2)
btnDiv=Button(Cal_F,padx=16,pady=1,bd=7,fg='red',font=('arial',16,'bold'),width=4,text='/',
                        bg='dodgerblue',command=lambda:btnClick('/')).grid(row=5,column=3)
